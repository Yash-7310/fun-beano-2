...
const allFaqs = [
  {
    ...
    answer:
      "Yes, 100% free. Our goal is to provide genuine value. If our advice helps, we hope you'll consider our paid services in the future, but there's no obligation whatsoever.",
  },
  {
    question: "How long until I get a response?",
    answer:
      "We personally respond to every inquiry. Please allow up to 48 business hours for our experts to craft a thoughtful and actionable response for you.",
  },
  {
