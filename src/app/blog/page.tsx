...
const blogPosts = [
  ...
  },
  {
    ...
    description: "A comprehensive guide to ensuring a safe and enjoyable playtime for your children, both at home and in our playzones.",
    image: "/SafetyHome1.png",
  },
  {
    id: "health-hygiene",
    title: "Health & Hygiene",
    description: "Learn about our strict hygiene protocols and get tips for keeping your little ones healthy during play.",
    image: "/SafetyHome3.png",
  },
  {
    id: "parenting-tips",
    title: "Parenting Tips",
    description: "Expert advice and helpful tips for modern parents, from managing screen time to encouraging social skills.",
